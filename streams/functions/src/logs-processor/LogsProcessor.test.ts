...
const batch: IWebhook = {
  ...
  chainId: '0x1',
  abis: {
    'ba3b3c52-3dd3-4eb7-a2b7-4b61d3439c5e': [
      {
        anonymous: false,
        inputs: [
          {
...
describe('LogsProcessor', () => {
  it('processes correctly', () => {
    ...
    expect(update0.tableName).toEqual('SomeTag');
    expect(update0.row.name).toEqual('Transfer');
    expect(update0.row.chainId).toEqual(1);
    expect(update0.row['from']).toEqual('0xb4e16d0168e52d35cacd2c6185b44281ec28c9dc');
    expect(update0.row['to']).toEqual('0x88ff79eb2bc5850f27315415da8685282c7610f9');
    expect(update0.row['value']).toEqual('1246846714');

    const update8 = updates[8];
    expect(update8.tableName).toEqual('SomeTag');
    expect(update8.row.name).toEqual('Approval');
    expect(update0.row.chainId).toEqual(1);
    expect(update8.row['spender']).toEqual('0x68b3465833fb72a70ecdf485e0e4c7bd8665fc45');
    expect(update8.row['owner']).toEqual('0x6ac0bf4b95985636d6f9a5c5e28e611cf8004683');
    expect(update8.row['value']).toEqual('5000000000');
  });
});
